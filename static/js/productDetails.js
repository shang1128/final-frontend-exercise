...
document.getElementsByClassName('black')[0].addEventListener('click', function(){
    document.getElementById('imageChanges').src="/static/Beats-earphone/beats__3.png";
})
document.getElementsByClassName('red')[0].addEventListener('click', function(){
    document.getElementById('imageChanges').src="/static/Beats-earphone/beat-red.png";
})
document.getElementsByClassName('blue')[0].addEventListener('click', function(){
    document.getElementById('imageChanges').src="/static/Beats-earphone/beats__4.png";
...
document.getElementsByClassName('white')[0].addEventListener('click', function(){
    document.getElementById('imageChanges').src="/static/Beats-earphone/beats__2.png";
})
document.getElementsByClassName('peach')[0].addEventListener('click', function(){
    document.getElementById('imageChanges').src="/static/Beats-earphone/beats__1.png";
})
